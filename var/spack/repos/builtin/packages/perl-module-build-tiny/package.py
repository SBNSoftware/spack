...
class PerlModuleBuildTiny(PerlPackage):
    ...
    depends_on("perl-extutils-parsexs", type="run")
    depends_on("perl-tap-harness-env", type="run")
    depends_on("perl-extutils-installpaths@0.2:", type="run")
    depends_on("perl-extutils-helpers@0.20:", type="run")
    depends_on("perl@5.6:", type=("build", "run", "test"))
    depends_on("perl-extutils-config@0.3:", type="run")
