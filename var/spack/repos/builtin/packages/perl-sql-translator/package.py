...
class PerlSqlTranslator(PerlPackage):
    ...
    depends_on("perl-json-maybexs@1.003.003:", type=("build", "test"))
    depends_on("perl-moo@1.000.003:", type=("build", "run", "test"))
    depends_on("perl-package-variant@1.001001:", type=("build", "run", "test"))
    depends_on("perl-parse-recdescent@1.967.009:", type=("build", "run", "test"))
